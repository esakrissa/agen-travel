  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!message || lastError.current === message) {
        // Message has already been logged. Do not modify the ref, return early.
        return;
      }
            ...
            <div className="absolute top-4 left-4 z-10">
              ...
              >
                ...
                <span className="sr-only">
                  {chatHistoryOpen ? "Close chat history" : "Open chat history"}
                </span>
              </Button>
            </div>
            ...
            content={
              <>
                ...
                {/* Special rendering case where there are no AI/tool messages, but there is an interrupt.
                    We need to render it outside the messages' list, since there are no messages to render */}
